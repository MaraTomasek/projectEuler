...
public class Problem11 : Problem {
    private static string Headline = @"Largest product in a grid";
...
01 70 54 71 83 51 54 69 16 92 33 48 61 43 52 01 89 19 67 48".Replace(Environment.NewLine, " ");
        ...
        // Convert String to 2D-Integer Array
        string[] linearStr = grid.Split(" ");
        int[,]   linearInt = new int[height, width];

        for (int i = 0; i < length; i++) {
            linearInt[i / height, i % height] = Convert.ToInt32(linearStr[i]);
        }
